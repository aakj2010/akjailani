...
function Skills() {
    return (
        ...
        //       <div class="col-lg-6 col-12">
        //         {/* <!-- <img src="undraw_React_re_g3ui.png" alt=""> --> */}
        //         <svg
        ...
        //             fill="#3f3d56"
        //           ></path>
        //           <circle cx="727.75919" cy="527.00841" r="8" fill="#fff"></circle>
        //           <path
            ...
            <section id="skill">
                ...
                <div class="container">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="card rounded shadow border-5 mb-2 mt-5 p-3 m-5" style={{ width: "14rem" }}>
                            {/* <img src="html..1.png" class="card-img-top" alt="..." /> */}
                           <FaHtml5 /> HTML

                        </div>

                        <div class="card rounded shadow border-5 mb-2 mt-5 p-3 m-5" style={{ width: "14rem" }}>
                            <img src="css...1.png" class="card-img-top" alt="..." />

                        </div>
                        <div class="card rounded shadow border-5 mb-2 mt-5 p-3 m-5" style={{ width: "14rem" }}>
                            <img src=" Javascript-shield.png" class="card-img-top" alt="..." />

                        </div>
                        <div class="card rounded shadow border-5 mb-2 mt-5 p-3 m-5" style={{ width: "14rem" }}>
                            <img src="React logo.png" class="card-img-top" alt="..." />

                        </div>
                        <div class="card rounded shadow border-5 mb-2 mt-5 p-3 m-5" style={{ width: "14rem" }}>
                            <img src="node..1.png" class="card-img-top" alt="..." />
                        </div>
                        <div class="card rounded shadow border-5 mb-2 mt-5 p-3 m-5" style={{ width: "14rem" }}>
                            {/* <img src="mongodb.png" class="card-img-top" alt="..." /> */}
                            <FaReact />  React
                        </div>
                    </div>
                </div>
